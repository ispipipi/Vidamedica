  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-semibold text-white">KPIs de licitaciones</h1>
      </div>

      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <KPICard label="Licitaciones visibles" value={proyectos.length} icon={FolderKanban} />
